<style>
    ...
    /* Search Bar Container Animation - Slide up with scale */
    ...
    .why-bheem-academy.animate-in .why-bheem-search-container {
        opacity: 1;
        transform: translateY(0) scale(1);
        transition-delay: 1s;
    }

    /* Search Input Animation - Width expand */
    ...
    .why-bheem-academy.animate-in .why-bheem-search-input {
        transform: scaleX(1);
        transition-delay: 1.2s;
    }

    /* Search Button Animation - Pop effect */
    ...
    .why-bheem-academy.animate-in .why-bheem-search-button {
        opacity: 1;
