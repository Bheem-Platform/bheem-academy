<?php
/**
 * Blog Detail Page - Full Functionality with Database Connection
 * Location: /bheem-components/blog-detail/view.php
 */
...
<head>
    ...
    <title>Blog Detail - Bheem Academy</title>
    ...
    * {
    ...
    #region-main {
        ...
        @media (max-width: 1024px) {
            /* Switch to two column layout (main + right sidebar) */
            .article-layout {
            ...
            /* Make sidebar even more compact on tablets */
            .sidebar-card {
                padding: 0.875rem;
            }
        ...
        @media (max-width: 768px) {
            ...
            /* Show right sidebar on mobile but at bottom */
            .right-sidebar {
                display: flex;
                gap: 1rem;
                margin-top: 1rem;
            ...
            /* Make sidebar cards horizontal on mobile for space efficiency */
            .sidebar-card {
                padding: 0.875rem;
            }
        ...
        .back-to-blog-btn {
            animation: slideInFromLeft 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.1s both;
        }
        ...
        @supports (-webkit-touch-callout: none) {
            ...
            .article-main,
            .toc-sidebar {
                /* Reduce backdrop-filter blur on iOS for better performance */
        ...
        @media (max-width: 768px) {
            /* Reduce backdrop blur on all mobile devices */
            .sidebar-card,
            .article-main,
            .toc-sidebar {
...
<?php
    ...
    $local_header = '/var/lib/docker/volumes/moodle-staging_moodle_data/_data/includes/bheem_header.php';
...
?>
    ...
    <div id="aiApp">
        ...
        <div class="content-wrapper">
            <!-- Back to Blog Button -->
            <a href="<?php echo $api_base_url; ?>/blog/list.php" class="back-to-blog-btn">
            ...
            <nav class="breadcrumbs">
                <div class="breadcrumb-item">
                    <a href="<?php echo $api_base_url; ?>"><i class="fas fa-home"></i> Home</a>
                </div>
                <span class="breadcrumb-separator">/</span>
                <div class="breadcrumb-item">
                    <a href="<?php echo $api_base_url; ?>/blog/list.php">Blog</a>
                </div>
                <span class="breadcrumb-separator">/</span>
                <div class="breadcrumb-item">
            ...
            <div v-else-if="error" class="error-state">
                ...
                <a href="<?php echo $api_base_url; ?>/blog/list.php" class="back-to-blog">
                    <i class="fas fa-arrow-left"></i>
                    <span>Back to Blog</span>
                </a>
            </div>
            ...
            <div v-else-if="entry" class="article-layout">
                ...
                <article class="article-main">
                    <!-- Featured Image -->
                    <div v-if="entry.featuredimage" class="featured-image-wrapper scroll-reveal-scale">
                        <img :src="entry.featuredimage" :alt="entry.subject" class="featured-image" loading="eager" decoding="async">
                    </div>
                ...
                <aside class="right-sidebar">
                    ...
                    <div class="sidebar-card author-card scroll-reveal-right">
                        ...
                        <img :src="entry.author.pictureurl" :alt="entry.author.fullname" class="author-avatar-large" loading="lazy">
                        <div>
        ...
        createApp({
            ...
            methods: {
                async fetchBlogEntry() {
                    try {
                        const response = await fetch(`<?php echo $api_base_url; ?>/blog/api/get_entry.php?entryid=${this.entryId}`);
                        const data = await response.json();

                        if (data.success) {
                            this.entry = data.entry;
                            this.relatedPosts = data.relatedPosts || [];
                            document.title = this.entry.subject + ' - Bheem Academy Blog';
                        } else {
