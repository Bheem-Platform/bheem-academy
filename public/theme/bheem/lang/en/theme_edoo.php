...
$string['choosereadme'] = 'Edoo Education & LMS Moodle Theme';
$string['pluginname'] = 'Edoo';

$string['edoo_settings_menu'] = 'Options';
$string['edoo_page_settings_menu'] = 'Page Settings';
...
$string['configtitle'] = 'Edoo settings';
...
// Theme Settings
    ...
    $string['edoo_facebook_url'] = 'Facebook URL';
    $string['edoo_facebook_url_desc'] = 'The link to your company\'s Facebook profile.';
    $string['edoo_twitter_url'] = 'Twitter URL';
    $string['edoo_twitter_url_desc'] = 'The link to your company\'s Twitter profile.';
    $string['edoo_instagram_url'] = 'Instagram URL';
    $string['edoo_instagram_url_desc'] = 'The link to your company\'s Instagram profile.';
    $string['edoo_dribbble_url'] = 'Dribbble URL';
    $string['edoo_dribbble_url_desc'] = 'The link to your company\'s Dribbble profile.';
    $string['edoo_pinterest_url'] = 'Pinterest URL';
    $string['edoo_pinterest_url_desc'] = 'The link to your company\'s Pinterest profile.';
    $string['edoo_google_url'] = 'Google URL';
    $string['edoo_google_url_desc'] = 'The link to your company\'s Google profile.';
    $string['edoo_youtube_url'] = 'YouTube URL';
    $string['edoo_youtube_url_desc'] = 'The link to your company\'s YouTube profile.';
    $string['edoo_vk_url'] = 'VK URL';
    $string['edoo_vk_url_desc'] = 'The link to your company\'s VK profile.';
    $string['edoo_500px_url'] = '500px URL';
    $string['edoo_500px_url_desc'] = 'The link to your company\'s 500px profile.';
    $string['edoo_behance_url'] = 'Behance URL';
    $string['edoo_behance_url_desc'] = 'The link to your company\'s Behance profile.';
    $string['edoo_digg_url'] = 'Digg URL';
    $string['edoo_digg_url_desc'] = 'The link to your company\'s Digg profile.';
    $string['edoo_flickr_url'] = 'Flickr URL';
    $string['edoo_flickr_url_desc'] = 'The link to your company\'s Flickr profile.';
    $string['edoo_foursquare_url'] = 'Foursquare URL';
    $string['edoo_foursquare_url_desc'] = 'The link to your company\'s Foursquare profile.';
    $string['edoo_linkedin_url'] = 'LinkedIn URL';
    $string['edoo_linkedin_url_desc'] = 'The link to your company\'s LinkedIn profile.';
    $string['edoo_medium_url'] = 'Medium URL';
    $string['edoo_medium_url_desc'] = 'The link to your company\'s Medium profile.';
    $string['edoo_meetup_url'] = 'Meetup URL';
    $string['edoo_meetup_url_desc'] = 'The link to your company\'s Meetup profile.';
    $string['edoo_snapchat_url'] = 'Snapchat URL';
    $string['edoo_snapchat_url_desc'] = 'The link to your company\'s Snapchat profile.';
    $string['edoo_tumblr_url'] = 'Tumblr URL';
    $string['edoo_tumblr_url_desc'] = 'The link to your company\'s Tumblr profile.';
    $string['edoo_vimeo_url'] = 'Vimeo URL';
    $string['edoo_vimeo_url_desc'] = 'The link to your company\'s Vimeo profile.';
    $string['edoo_wechat_url'] = 'WeChat URL';
    $string['edoo_wechat_url_desc'] = 'The link to your company\'s WeChat profile.';
    $string['edoo_whatsapp_url'] = 'WhatsApp URL';
    $string['edoo_whatsapp_url_desc'] = 'The link to your company\'s WhatsApp profile.';
    $string['edoo_wordpress_url'] = 'WordPress URL';
    $string['edoo_wordpress_url_desc'] = 'The link to your company\'s WordPress profile.';
    $string['edoo_weibo_url'] = 'Weibo URL';
    $string['edoo_weibo_url_desc'] = 'The link to your company\'s Weibo profile.';
    $string['edoo_telegram_url'] = 'Telegram URL';
    $string['edoo_telegram_url_desc'] = 'The link to your company\'s Telegram profile.';
    $string['edoo_moodle_url'] = 'Moodle URL';
    $string['edoo_moodle_url_desc'] = 'The link to your company\'s Moodle profile.';
    $string['edoo_amazon_url'] = 'Amazon URL';
    $string['edoo_amazon_url_desc'] = 'The link to your company\'s Amazon profile.';
    $string['edoo_slideshare_url'] = 'SlideShare URL';
    $string['edoo_slideshare_url_desc'] = 'The link to your company\'s SlideShare profile.';
    $string['edoo_soundcloud_url'] = 'Soundcloud URL';
    $string['edoo_soundcloud_url_desc'] = 'The link to your company\'s Soundcloud profile.';
    $string['edoo_leanpub_url'] = 'Leanpub URL';
    $string['edoo_leanpub_url_desc'] = 'The link to your company\'s Leanpub profile.';
    $string['edoo_xing_url'] = 'Xing URL';
    $string['edoo_xing_url_desc'] = 'The link to your company\'s Xing profile.';
    $string['edoo_bitcoin_url'] = 'Bitcoin URL';
    $string['edoo_bitcoin_url_desc'] = 'The link to your company\'s Bitcoin profile.';
    $string['edoo_twitch_url'] = 'Twitch URL';
    $string['edoo_twitch_url_desc'] = 'The link to your company\'s Twitch profile.';
    $string['edoo_github_url'] = 'Github URL';
    $string['edoo_github_url_desc'] = 'The link to your company\'s Github profile.';
    $string['edoo_gitlab_url'] = 'Gitlab URL';
    $string['edoo_gitlab_url_desc'] = 'The link to your company\'s Gitlab profile.';
    $string['edoo_forumbee_url'] = 'Forumbee URL';
    $string['edoo_forumbee_url_desc'] = 'The link to your company\'s Forumbee profile.';
    $string['edoo_trello_url'] = 'Trello URL';
    $string['edoo_trello_url_desc'] = 'The link to your company\'s Trello profile.';
    $string['edoo_weixin_url'] = 'Weixin URL';
    $string['edoo_weixin_url_desc'] = 'The link to your company\'s Weixin profile.';
    $string['edoo_slack_url'] = 'Slack URL';
    $string['edoo_slack_url_desc'] = 'The link to your company\'s Slack profile.';

    $string['banner_image']              = 'Page Banner Image';
    $string['banner_image_desc']         = 'Your website page banner image.';

    $string['banner_shape']              = 'Page Banner Shape Image';
    $string['banner_shape_desc']         = 'Your website page banner shape image.';
