 ...
 * Version: 4.0 - FULL DATABASE INTEGRATION
 */
...
<!-- Header Version: 3.0 - Course Pages Header - Updated: <?php echo date('Y-m-d H:i:s'); ?> - Cache Bust: <?php echo time(); ?> -->
<!-- Font Awesome -->
...
<style>
  /* Hide all Moodle default navigation elements - COMPREHENSIVE */
  .navbar-area,
  #navbar,
  .mobile-navbar,
  #navbarOffcanvas,
    ...
    <div class="header-container">
        ...
        <div class="logo-section">
            <a href="https://dev.bheem.cloud/" class="brand-logo">
                <img src="https://dev.bheem.cloud/pluginfile.php/1/theme_bheem/main_logo/-1/logo.png" alt="Bheem Academy" class="logo-img">
            </a>
        </div>
