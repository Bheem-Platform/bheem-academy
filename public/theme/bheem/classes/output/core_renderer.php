...
class core_renderer extends \core_renderer {
   ...
   */
    ...
    public function get_theme_image_banner_image($maxwidth = null, $maxheight = 100) {
        global $CFG;
        if (!empty($this->page->theme->settings->banner_image)) {
            $url = $this->page->theme->setting_file_url('banner_image', 'banner_image');
            // Get a URL suitable for moodle_url.
            $relativebaseurl = preg_replace('|^https?://|i', '//', $CFG->wwwroot);
            $url = str_replace($relativebaseurl, '', $url);
            return new moodle_url($url);
            return parent::get_theme_image_banner_image($maxwidth, $maxheight);
        }
    }

    public function get_theme_image_banner_shape($maxwidth = null, $maxheight = 100) {
        global $CFG;
        if (!empty($this->page->theme->settings->banner_image)) {
            $url = $this->page->theme->setting_file_url('banner_shape', 'banner_shape');
            // Get a URL suitable for moodle_url.
            $relativebaseurl = preg_replace('|^https?://|i', '//', $CFG->wwwroot);
            $url = str_replace($relativebaseurl, '', $url);
            return new moodle_url($url);
            return parent::get_theme_image_banner_shape($maxwidth, $maxheight);
        }
    }
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_bheem/lang_menu', $context);
            }
        }
    }
     ...
     * @return string
     */
    public function edoo_is_siteadmin() {
        if(is_siteadmin()){
    ...
    */
    ...
    public function if_home_pages() {
        ...
        $hide_banner            = get_config('theme_bheem', 'hide_banner');
    ...
    public function if_hide_page_bottom_content() {
        ...
        $hide_page_bottom_content      = get_config('theme_bheem', 'hide_page_bottom_content');
    ...
    public function banner_image() {
        $url = new moodle_url('/theme/bheem/pix/img/page-banner.png');
        return $url;
    }
     ...
     * @return string
     */
    public function banner_shape() {
        $url = new moodle_url('/theme/bheem/pix/img/page-shape.png');
        return $url;
    }
     ...
     * @return string
     */
    public function edoo_if_user_enrolled() {
     ...
     * @return string
     */
    public function edoo_enroll_link() {
        $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
        $id = $_GET['id'];
        global $CFG;
     ...
     * if_guest
     */
    public function if_edoo_guest() {
        $hide_guest_access_curriculum       = '';
        $hide_guest_access_curriculum       = theme_bheem_get_setting('hide_guest_access_curriculum');
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/bheem/pix";
    }
    ...
    public function get_footer_bottom() {
        $footer_copyright       = '';
        $footer_copyright       = theme_bheem_get_setting('footer_copyright');
        ob_start();
            if($footer_copyright):
                ?>
                <div class="bg-gray4">
                    <div class="container">
                        <div class="border-top">
                            <p class="copyright text-center py-4"><?php echo $footer_copyright; ?></p>
                        </div>
                    </div>
                </div>
                <?php
    ...
    public function search_box($id = false) {
        global $CFG;
        $search_placeholder = '';
        $search_placeholder = theme_bheem_get_setting('search_placeholder', true);
        $wwwroot = $CFG->wwwroot;
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if ($withlinks) {
            ...
            foreach ($opts->navitems as $key => $value) {
                ...
                switch ($value->itemtype) {
                    ...
                    case 'link':                        
                        $edoo_nav_items .= '<a class="dropdown-item" href="'. $value->url .'">'. $value->title .'</a>';
        ...
        return $edoo_nav_items;
    }

    /**
     * region_main_settings_menu
     */
    public function edoo_region_main_settings_menu() {
        global $OUTPUT;
