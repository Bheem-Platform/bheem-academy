...
<header class="professional-header" id="professionalHeader">
    <div class="header-container">
        ...
        <div class="header-actions">
            ...
            $is_dashboard = in_array($current_script, ['student-dashboard.php', 'parent-dashboard.php', 'mentor-dashboard.php']);
            ...
            <?php if ($is_logged_in): ?>
                <div class="login-dropdown-container">
                    ...
                    <div class="login-dropdown">
                        ...
                        <?php else: ?>
                            <a href="<?php echo $CFG->wwwroot; ?>/student-dashboard.php" class="login-dropdown-item">
            ...
            <?php else: ?>
                <div class="login-dropdown-container">
                    ...
                    <div class="login-dropdown">
                        ...
                        <a href="<?php echo $CFG->wwwroot; ?>/mentor-dashboard.php" class="login-dropdown-item">
                            <i class="fas fa-chalkboard-teacher"></i>
                            <span>Mentor</span>
                        </a>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
        <?php if ($is_logged_in): ?>
            ...
            <?php else: ?>
                <div class="mobile-nav-item">
                    <a href="<?php echo $CFG->wwwroot; ?>/student-dashboard.php" class="mobile-nav-link">
                        <i class="fas fa-tachometer-alt"></i>
                        Dashboard
                    </a>
                </div>
        ...
        <?php else: ?>
            <div class="mobile-nav-item">
                ...
                <div class="mobile-dropdown" id="mobile-login">
                    ...
                    <a href="<?php echo $CFG->wwwroot; ?>/mentor-dashboard.php" class="mobile-dropdown-item">
