<?php
// Student Dashboard - Connected to Real Moodle Database
// IMPORTANT: Only authenticated users can access this page
...
try {
    ...
    // ===== STUDENT USERTYPE VALIDATION =====
    // Only users with "Student" usertype can access this dashboard
    ...
    // Check if usertype is "Student" (case-insensitive)
    if (strtolower(trim($usertype)) !== 'student') {
        ...
        if ($detected_usertype === 'mentor') {
            // Mentor trying to access student dashboard - redirect to mentor dashboard
            redirect($CFG->wwwroot . '/mentor-dashboard.php');
        } elseif ($detected_usertype === 'parent') {
            // Parent trying to access student dashboard - redirect to parent dashboard
            redirect($CFG->wwwroot . '/parent-dashboard.php');
        } else {
            // Unknown usertype or no usertype - redirect to login page with error
    ...
    // ===== END STUDENT USERTYPE VALIDATION =====
...
<head>
    ...
    <title>Student Dashboard - Bheem Academy</title>
        ...
        <div class="dashboard-container">
            ...
            <main class="main-content">
                ...
                <div v-if="activeSection === 'courses'">
                    <div class="content-header">
                        ...
                        <p class="page-subtitle">Manage and continue your enrolled courses</p>
                    </div>
                ...
                <div v-if="activeSection === 'assignments'">
                    <div class="content-header">
                        ...
                        <p class="page-subtitle">Track your assignments and submissions</p>
                    </div>
                ...
                <div v-if="activeSection === 'grades'">
                    ...
                    <div class="courses-section">
                        ...
                        <p style="color: #6b7280; padding: 20px 0;">Your grades and performance metrics will be displayed here once you complete assessments.</p>
                    </div>
                </div>
            ...
            <aside class="right-sidebar">
                ...
                <div class="widget">
                    ...
                    <button class="dark-mode-toggle" @click="toggleDarkMode" title="Toggle Dark Mode" style="width: 100%; height: auto; padding: 12px; border-radius: 10px; font-size: 16px; display: flex; align-items: center; justify-content: center; gap: 10px;">
