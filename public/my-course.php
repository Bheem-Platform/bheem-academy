...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $CFG->wwwroot; ?>/course/styles/design-system-2025.css?v=<?php echo filemtime(__DIR__ . '/course/styles/design-system-2025.css'); ?>">
    <link rel="stylesheet" href="<?php echo $CFG->wwwroot; ?>/course/styles/components-2025.css?v=<?php echo filemtime(__DIR__ . '/course/styles/components-2025.css'); ?>">
    <link rel="stylesheet" href="<?php echo $CFG->wwwroot; ?>/course/styles/elegant-enhancements.css?v=<?php echo filemtime(__DIR__ . '/course/styles/elegant-enhancements.css'); ?>">
    <link rel="stylesheet" href="<?php echo $CFG->wwwroot; ?>/course/styles/hero-compact.css?v=<?php echo filemtime(__DIR__ . '/course/styles/hero-compact.css'); ?>">
    <link rel="stylesheet" href="<?php echo $CFG->wwwroot; ?>/course/styles/cta-card-professional.css?v=<?php echo filemtime(__DIR__ . '/course/styles/cta-card-professional.css'); ?>">
