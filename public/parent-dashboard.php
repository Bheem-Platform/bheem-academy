<?php
// Parent Dashboard - Connected to Real Moodle Database
// IMPORTANT: Only authenticated parents can access this page
...
try {
    ...
    // ===== PARENT USERTYPE VALIDATION =====
    // Only users with "Parent" usertype can access this dashboard
    ...
    // Check if usertype is "Parent" (case-insensitive)
    if (strtolower(trim($usertype)) !== 'parent') {
        // User is not a parent, redirect to login with error (logout will happen on login page)
        $detected_usertype = strtolower(trim($usertype));

        // Redirect to login page with access denied error - DON'T logout here as it auto-redirects
        if ($detected_usertype === 'student') {
        ...
        } elseif ($detected_usertype === 'mentor') {
            redirect(new moodle_url('/login/academy-login.php', array(
                'error' => 'access_denied',
                'attempted' => 'parent',
                'usertype' => 'mentor',
            ...
            // Unknown usertype or no usertype
            redirect(new moodle_url('/login/academy-login.php', array(
                'error' => 'access_denied',
                'attempted' => 'parent',
                'usertype' => 'unknown',
    ...
    // ===== END PARENT USERTYPE VALIDATION =====
...
// Fetch enrolled courses for monitoring (in real parent dashboard, this would be children's courses)
try {
...
<head>
    ...
    <title>Parent Dashboard - Bheem Academy</title>
    ...
    <style>
        ...
        :root {
            /* Light mode colors - Parent Dashboard uses warm family-oriented colors */
            --bg-primary: #f8fafc;
            --bg-secondary: #ffffff;
            --bg-tertiary: #f8fafc;
            --bg-hover: #f1f5f9;
            ...
            --parent-primary: #ec4899; /* Pink for parent theme */
            --parent-secondary: #f472b6;
        }
        ...
        body.dark-mode .welcome-hero {
            background: linear-gradient(135deg, #db2777 0%, #9333ea 50%, #c026d3 100%);
        }
        ...
        * {
        ...
        .dashboard-header {
            ...
            box-shadow: 0 2px 20px rgba(236, 72, 153, 0.15);
            display: flex;
            align-items: center;
        ...
        <div class="dashboard-container">
            ...
            <header class="dashboard-header" style="position: relative; top: 0;">
                <div class="header-left">
                    <h2 style="margin: 0; color: white; font-size: 20px; font-weight: 600;">
                        <i class="fas fa-user-friends"></i> Parent Dashboard
                    </h2>
                </div>
            ...
            <aside class="left-sidebar">
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-item">
                            <a class="sidebar-link" @click="setActiveSection('messages')">
                                <i class="fas fa-envelope sidebar-icon"></i>
                                Messages
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" @click="setActiveSection('teachers')">
                                <i class="fas fa-chalkboard-teacher sidebar-icon"></i>
                                Teachers
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" @click="setActiveSection('calendar')">
            ...
            <main class="main-content">
                    ...
                    <div class="welcome-hero">
                        <div class="welcome-content">
                            ...
                            <div class="welcome-text">
                                ...
                                <p class="welcome-message">Stay updated on your child's educational journey</p>
                            </div>
                        </div>
                            ...
                            <div class="quick-actions-list">
                                <a href="https://dev.bheem.cloud/message/" class="action-item">
                                    ...
                                    <div class="action-text">
                                        <div class="action-title">Message Teachers</div>
                                        <div class="action-desc">Communicate directly</div>
                                    </div>
                                ...
                                <a href="https://dev.bheem.cloud/grade/report/overview/index.php" class="action-item">
                                    ...
                                    <div class="action-text">
                                        ...
                                        <div class="action-desc">Academic progress</div>
                                    </div>
                                    <i class="fas fa-chevron-right action-arrow"></i>
                                </a>
                                <a href="https://dev.bheem.cloud/calendar/view.php" class="action-item">
                                    <div class="action-icon" style="background: linear-gradient(135deg, #10b981, #059669)">
                                        <i class="fas fa-calendar-alt"></i>
                                    </div>
                                    <div class="action-text">
                                        <div class="action-title">School Calendar</div>
                                        <div class="action-desc">Events & deadlines</div>
                                    </div>
                                    <i class="fas fa-chevron-right action-arrow"></i>
                                </a>
                                <a href="https://dev.bheem.cloud/my/" class="action-item">
                                    ...
                                    <div class="action-text">
                                        <div class="action-title">Moodle Dashboard</div>
                                        <div class="action-desc">Full system access</div>
                                    </div>
                                    <i class="fas fa-chevron-right action-arrow"></i>
                                </a>
                            </div>
                        ...
                        <div class="widget-card">
                            ...
                            <div style="padding: 10px 0;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                                    <span style="color: var(--text-secondary); font-size: 14px;">Average Progress</span>
                                    <span style="font-weight: 600; color: var(--text-primary);">75%</span>
                                </div>
                                <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                                    <span style="color: var(--text-secondary); font-size: 14px;">Attendance Rate</span>
                                    <span style="font-weight: 600; color: #10b981;">95%</span>
                                </div>
                                <div style="display: flex; justify-content: space-between;">
                                    <span style="color: var(--text-secondary); font-size: 14px;">On-Time Submissions</span>
                                    <span style="font-weight: 600; color: #667eea;">88%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div v-if="activeSection === 'courses'">
                    <div class="content-header">
                        <h1 class="page-title">Children's Courses</h1>
                        <p class="page-subtitle">Monitor enrolled courses and progress</p>
                    </div>
                ...
                <div v-if="activeSection === 'assignments'">
                    <div class="content-header">
                        ...
                        <p class="page-subtitle">Track assignment submissions and deadlines</p>
                    </div>
                ...
                <div v-if="activeSection === 'grades'">
                    <div class="content-header">
                        <h1 class="page-title">Progress & Grades</h1>
                        <p class="page-subtitle">Monitor academic performance and achievements</p>
                    </div>
                    ...
                    <div class="courses-section">
                        ...
                        <p style="color: #6b7280; padding: 20px 0;">Detailed grade reports and progress tracking will be displayed here.</p>
                    </div>
                </div>

                <!-- Other sections -->
                <div v-if="['messages', 'teachers', 'calendar', 'profile', 'settings'].includes(activeSection)">
                    <div class="content-header">
                ...
                <div class="widget">
                    ...
                    <div style="padding: 10px 0;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            <span style="color: var(--text-secondary); font-size: 14px;">Study Time</span>
                            <span style="font-weight: 600; color: #ec4899;">12h 30m</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            <span style="color: var(--text-secondary); font-size: 14px;">Assignments</span>
                            <span style="font-weight: 600; color: #10b981;">8/10</span>
                        </div>
                        <div style="display: flex; justify-content: space-between;">
                            <span style="color: var(--text-secondary); font-size: 14px;">Attendance</span>
            ...
            methods: {
                ...
                getSectionSubtitle(section) {
                    const subtitles = {
                        ...
                        teachers: 'View teacher information and contact details',
